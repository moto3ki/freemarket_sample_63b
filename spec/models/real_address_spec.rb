...
describe RealAddress do
  describe '#create' do
    ...
    # 郵便番号が6桁以下の数値の場合
    it "is invalid less than 6-digits-numbers" do
    ...
    # 郵便番号が7桁でハイフンが入る場合
    it "is invalid with 7-digits-numbers and hyphen" do
      real_address = build(:real_address, post_code: "123-4567")
      real_address.valid?
      expect(real_address.errors[:post_code]).to include("フォーマットが不適切です")
    end

    # 郵便番号が7桁の数値の場合
    it "is valid with 7-digits-numbers" do
